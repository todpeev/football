...
public abstract class Player implements MoveStrategy {
     ...
     */
	public Player(Team team, int playerNumber, String position) {
		this.team = team;
	...
	private MoveDirection positionDirection;
	
	/**
	 * Gets the direction of the starting position for the player, relative to current position.
	 * @return the position direction
	 */
	public MoveDirection getPositionDirection(){
		return positionDirection;
	}
	
	public void setPositionDirection(MoveDirection value){
	...
	public abstract boolean PlayerShouldMoveTowardsBall(int ballXCoordinate, int fieldWidth);
	...
	public void setHasBall(boolean value){
	  ...
	  public  void setSkipMove(boolean value){
		  skipMove = value;
	  }
}
